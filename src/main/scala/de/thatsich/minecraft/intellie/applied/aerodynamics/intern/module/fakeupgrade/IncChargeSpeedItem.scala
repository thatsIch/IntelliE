 ...
 * @since 12.08.2014.
 */
class IncChargeSpeedItem(modid: ID, log: Log) extends BaseItem(modid, new IncChargeSpeedID, log)

private[this] class IncChargeSpeedID extends BaseID("incChargeSpeed")