...
import de.thatsich.minecraft.common.string.id.{BaseID, ID, SimpleID}
 ...
 * @since 12.08.2014.
 */
class MiningLevel(modid: ID, log: Log) extends FakeBaseItem(modid, new SimpleID("mininglevel"), log)